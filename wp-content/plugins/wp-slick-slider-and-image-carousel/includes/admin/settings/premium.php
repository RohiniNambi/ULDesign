...
<div class="wrap">
	...
	<style>
		...
		.wpos-plugin-pricing-table tfoot .wpos-button{font-weight: 600; color: #fff; text-decoration: none; border:0px; cursor:pointer; text-transform: lowercase; display: inline-block; padding: 1em 2em; background: #59c7fb; border-radius: .2em;}
	</style>
